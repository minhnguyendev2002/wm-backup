    ...
    <div>
            ...
            <div class="container mx-auto px-10">
                ...
                <div class="grid grid-cols-12 gap-8">
                    <div
                        ...
                        :key="service.id"
                        class="group relative rounded-sm overflow-hidden hover:after:h-full hover:after:top-0 col-span-12 sm:col-span-6 xl:col-span-4 text-center py-14 px-10 bg-white flex flex-col justify-center items-center
                    ...
                    >
                        ...
                        <nuxt-link to="/" class="group-hover:!text-white delay-300 !text-second-100 mt-3 text-2xl font-bold relative z-10">
                            {{ service.title }}
                        </nuxt-link>
                    </div>
                </div>
        ...
        <div class="bg-[#f6f6f6]">
            <div class="container mx-auto py-20">
                <div class="w-full">
                    <h2 class="text-2xl sm:text-[40px] sm:leading-[55px] font-bold text-second-100 mb-10">
                        Thành tích đạt được
                    </h2>
                    <div class="border-2 border-solid border-gray-20">
                        <div
                        ...
                        >
                            ...
                            <div class="text-center">
                                <span class="text-xl">Giờ làm việc</span>
                                <h2 class="text-2xl">
        ...
        <div class="container mx-auto">
            <div data-aos="fade-top" data-aos-anchor-placement="top">
                <h2 class="text-2xl text-center sm:text-[40px] sm:leading-[55px] font-bold text-second-100 mt-20 mb-10">
                    Những con số về Wealth Managament
                </h2>
            </div>
            <div class="relative pb-24 lg:pb-32 pt-12 lg:pt-24 grid grid-cols-12 items-center gap-y-16 gap-5">
                <div class="col-span-12 lg:col-span-4">
                    <div class="text-center flex items-center justify-center">
                        <CountUp :value="2300" class="text-[50px] lg:text-[65px] font-bold" />
                ...
                <div class="col-span-12 lg:col-span-4">
                    <div class="text-center flex items-center justify-center">
                        <CountUp :value="600000" class="text-[50px] lg:text-[65px] font-bold" />
                        <span><i class="fas fa-plus text-3xl ml-2" /></span>
                    </div>
                    <span class="mt-10 mx-auto block text-center text-2xl text-prim-100 font-semibold">
                        Lượt truy cập
                ...
                <div class="col-span-12 lg:col-span-4">
                    <div class="text-center flex items-center justify-center">
                        <CountUp :value="160" class="text-[50px] lg:text-[65px] font-bold" />
                        <span><i class="fas fa-plus text-3xl ml-2" /></span>
                    </div>
                    <span class="mt-10 mx-auto block text-center text-2xl text-prim-100 font-semibold">
                        Doanh nghiệp
        ...
        <div class="py-20 relative bg-[url('/images/backgrounds/trade.png')] bg-cover bg-no-repeat bg-center">
            <div class="container">
                <h2 class="text-center text-3xl sm:text-[40px] sm:leading-[55px] font-bold text-second-100 mb-5">
                    Tổng quan về tỷ giá hối đoái quốc tế chính
                </h2>
                <ChartOverView />
            </div>
        </div>
...
<script>
    ...
    import ChartOverView from '@/components/shared/ChartOverVIew.vue';
    ...
    export default {
                ...
                banners: [
                    {
                        ...
                        subtitle: 'Wealth Managament cung cấp công nghệ tài liệu bằng sáng chế toàn cầu, cho phép người dùng sao chép miễn phí các nhà đầu tư yêu thích của họ',
                    },
                    {
        ...
        //         try {
        //             this.loading = true;
        //             await this.$store.dispatch('home/fetchAll');
        //         } catch (err) {
