    ...
    <div class="2xl:max-w-[1500px] mx-auto bg-white lg:py-1 px-3 md:px-6 flex justify-between items-center">
        <div class="flex items-center w-full">
            ...
            <div class="ml-auto flex gap-3">
                <div class="gap-3 hidden sm:flex">
                    <a href="https://www.wmvncrmonline.com/pc/user/login">
                        <a-button type="primary" class="!bg-prim-100">
                            Đăng nhập
                        </a-button>
                    </a>
                    <a href="https://www.wmvncrmonline.com/pc/user/regist">
                        <a-button type="primary" class="!bg-prim-100">
                            Đăng ký ngay
                        </a-button>
                    </a>
        ...
        >
            ...
            <div class="gap-3 sm:hidden flex justify-between mt-10">
                <a class="block w-full text-center" href="https://www.wmvncrmonline.com/pc/user/login">
                    <a-button type="primary" class="!bg-prim-100">
                        Đăng nhập
                    </a-button>
                </a>
                <a class="block w-full text-center" href="https://www.wmvncrmonline.com/pc/user/regist">
                    <a-button type="primary" class="!bg-prim-100">
                        Đăng ký ngay
                    </a-button>
                </a>
