<template>
    <div class="flex justify-between">
        ...
        <a href="tel:0904588802" class="fixed inline-block sm:hidden text-center bottom-[120px] z-50 w-14 h-14 rounded-full bg-prim-100 !text-white hover:bg-prim-100 transition-all duration-700 right-4 sm:right-8">
